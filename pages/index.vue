<template>
  <div>
    ...
    <section class="flex container margin__top--150">
      <article class="container__article">
        ...
        <ul>
          ...
          <li>Montaż bram garażowych</li>
          <li>Montaż systemów balkonowych</li>
          <li>Montaż ogrodów zimowych</li>
          <li>Montaż Fasad</li>
      ...
      <article class="container__article">
        ...
        <h3>Montaż surowy:</h3>
        <p>Surowy montaż okien stosowany jest w przypadku przypadku budynków w stanie surowym</p>
        <h3>Montaż pełny:</h3>
        <p>Pełny montaż okien stosowany w przypadku budynków, w krórych okna zostaną wymienione</p>
        <h3>Montaż ciepły</h3>
        <p>Polega na zastosowaniu trzech warstw składających się z:
        </p>
        <ul>
          <li>Zewnętrznej</li>
          <li>Środkowej</li>
    ...
    <section class="container container--center margin__top--150">
